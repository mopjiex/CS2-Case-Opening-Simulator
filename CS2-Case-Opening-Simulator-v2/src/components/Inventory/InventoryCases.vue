...
<template>
    <div class="inventory-content">
        <h1 class="text-4xl text-center mb-6">Инвентарь</h1>
        <div class="flex gap-4 flex-wrap justify-center text-black" v-if="!caseStore.casesLoading">
            <div class="case-box py-2 px-4 my-gradient rounded-md cursor-pointer"
            ...
            >
                ...
                <div class="text-xl">
                    <div class="border-t-8 rounded-xl border-[#4682B4] mb-6"></div>
